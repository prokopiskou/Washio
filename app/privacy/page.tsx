        ...
        <div className="flex flex-col gap-6 text-[14px] leading-relaxed text-gray-700">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 flex flex-col gap-1">
              ...
              <li><strong>Κρατήσεις & πληρωμές:</strong> ιστορικό κρατήσεων, ποσά. Τα στοιχεία κάρτας τα διαχειρίζεται αποκλειστικά πιστοποιημένος πάροχος πληρωμών — δεν τα αποθηκεύουμε εμείς.</li>
          ...
          <section>
            ...
            <p>
              ...
              την υποστήριξη και την ασφάλεια.
            </p>
            <p className="mt-2">
              Εφόσον το επιλέξεις, χρησιμοποιούμε επίσης το email/τηλέφωνό σου για να σου στέλνουμε προσφορές, νέα και
              ενημερώσεις για υπηρεσίες του Washio. Μπορείς να διαγραφείς ανά πάσα στιγμή (opt-out) με ένα κλικ ή στο
              {' '}<a href="mailto:support@washio.gr" className="text-blue-600">support@washio.gr</a>.
            </p>
            <p className="mt-2">
              Νομική βάση (GDPR): εκτέλεση σύμβασης (κρατήσεις/πληρωμές), έννομο συμφέρον (ασφάλεια, βελτίωση,
              ενημέρωση πελατών για παρόμοιες υπηρεσίες) και η συγκατάθεσή σου (τοποθεσία, ειδοποιήσεις, εμπορική επικοινωνία).
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-1.5">4. Με ποιους τα μοιραζόμαστε</h2>
            <p>Με εκτελούντες την επεξεργασία (data processors), αυστηρά για τη λειτουργία της υπηρεσίας:</p>
            <ul className="list-disc pl-5 mt-2 flex flex-col gap-1">
              <li>Πάροχος βάσης δεδομένων & ταυτοποίησης χρηστών.</li>
              <li>Πάροχος επεξεργασίας πληρωμών.</li>
              <li>Πάροχος αποστολής email.</li>
              <li>Πάροχος φιλοξενίας (hosting).</li>
              <li>Πάροχος υπηρεσιών χαρτογράφησης.</li>
              <li><strong>Συνεργαζόμενα πρατήρια</strong> — μόνο τα στοιχεία της δικής σου κράτησης (π.χ. ώρα, υπηρεσία, πινακίδα).</li>
            </ul>
            <p className="mt-2">Δεν πουλάμε ποτέ τα δεδομένα σου. Πλήρης κατάλογος εκτελούντων διατίθεται κατόπιν αιτήματος στο <a href="mailto:support@washio.gr" className="text-blue-600">support@washio.gr</a>.</p>
          </section>
